...
// System Exception and System Fault Handlers (Weak Definitions as Aliases to Default_Handler)
...
/*
On RESET vec_tab[0] --> SP and vec_tab[1] --> PC and then the Reset_Handler takes control
16 standard corex-m3 and 60 STM32-specific handlers
*/
__attribute__((section(".vectors"))) const uint32_t vec_tab[16 + 60] = 
{
    (uint32_t)&_sstack,
